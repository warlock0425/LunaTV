export const buttonStyles = {
  ...
  // 次要操作按鈕（灰色）- 用於取消、關閉等
  secondary:
    'px-3 py-1.5 text-sm font-medium bg-zinc-600 hover:bg-zinc-700 dark:bg-zinc-600 dark:hover:bg-zinc-700 text-white rounded-lg transition-colors',
  // 警告操作按鈕（黃色）- 用於批量禁用等
  warning:
  ...
  // 小尺寸次要按鈕
  secondarySmall:
    'px-2 py-1 text-xs font-medium bg-zinc-600 hover:bg-zinc-700 dark:bg-zinc-600 dark:hover:bg-zinc-700 text-white rounded-md transition-colors',
  // 小尺寸警告按鈕
  warningSmall:
  ...
  roundedSecondary:
    'inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-zinc-100 text-zinc-800 hover:bg-zinc-200 dark:bg-zinc-700/40 dark:hover:bg-zinc-700/60 dark:text-zinc-200 transition-colors',
  roundedWarning:
  ...
  // 禁用狀態
  disabled:
    'px-3 py-1.5 text-sm font-medium bg-zinc-400 dark:bg-zinc-600 cursor-not-allowed text-white rounded-lg transition-colors',
  disabledSmall:
    'px-2 py-1 text-xs font-medium bg-zinc-400 dark:bg-zinc-600 cursor-not-allowed text-white rounded-md transition-colors',
  // 開關按鈕樣式
  toggleOn: 'bg-green-600 dark:bg-green-600',
  toggleOff: 'bg-zinc-200 dark:bg-zinc-700',
  toggleThumb: 'bg-white',
  toggleThumbOn: 'translate-x-6',
  toggleThumbOff: 'translate-x-1',
  // 快速操作按鈕樣式
  quickAction:
    'px-3 py-1.5 text-xs font-medium text-zinc-600 dark:text-zinc-400 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 hover:bg-zinc-50 dark:hover:bg-zinc-700 rounded-md transition-colors',
};
