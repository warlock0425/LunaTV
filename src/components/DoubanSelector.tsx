    ...
    return (
      ...
      >
        ...
        {indicatorStyle.width > 0 && (
          <div
            className='absolute top-0.5 bottom-0.5 sm:top-1 sm:bottom-1 bg-accent rounded-full shadow-sm transition-all duration-300 ease-out'
            style={{
